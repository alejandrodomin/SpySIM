...
BEGIN_EVENT_TABLE(SpySIMDialog, wxDialog)
    EVT_CLOSE(SpySIMDialog::OnClose)
    EVT_BUTTON(idBtnQuit, SpySIMDialog::OnQuit)
    EVT_BUTTON(idBtnAbout, SpySIMDialog::OnAbout)
END_EVENT_TABLE()

SpySIMDialog::SpySIMDialog(wxDialog *dlg, const wxString &title)
...
SpySIMDialog::~SpySIMDialog()
{
}

void SpySIMDialog::OnClose(wxCloseEvent &event)
{
    Destroy();
}

void SpySIMDialog::OnQuit(wxCommandEvent &event)
{
    Destroy();
}

void SpySIMDialog::OnAbout(wxCommandEvent &event)
{
